...
pacstrap /mnt wget htop neofetch screenfetch networkmanager firefox obs-studio sudo nano vim discord base-devel git jre-openjdk-headless python3 python-pip cmake qt6 qt5
